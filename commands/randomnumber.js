...
module.exports = {
	...
	execute(message, args) {
		let errorMessage = new Discord.MessageEmbed().setTitle(':x: **Error**').setColor(0xdc2e44).setFooter('OneSearch', 'https://cdn.bcow.tk/assets/logo%20450.png');
		var range1 = args[1];
		var range2 = args[2];
		...
		const rngEmbed1 = new Discord.MessageEmbed().setTitle('Random Number').setColor(0x0071bc).addField('Range', range1 + '-' + range2).addField('Number', rng1).setFooter('OneSearch', 'https://cdn.bcow.tk/assets/logo.png');
