...
const { Town, TownP, Nation } = require('../../models/models');
...
module.exports = async (message, args) => {
  ...
  const town = await Town.findOne({ nameLower: query }).exec().catch(err => {return errorMessage.setDescription('An error occurred.')});
