...
exports.default = (message, args, client) => __awaiter(void 0, void 0, void 0, function* () {
    const data = yield fetch_1.getPlayer(args[1]);
    ...
    const town = yield models_1.Town.findOne({ membersArr: { $in: [data.data.player.username] } }).exec().catch(err => message.channel.send(statusMessage_1.errorMessage.setDescription('An error occurred.')));
