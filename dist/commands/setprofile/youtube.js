...
exports.default = (message, args, player) => __awaiter(void 0, void 0, void 0, function* () {
    if (args[2] == 'null') {
        ...
        player.save();
        message.channel.send(statusMessage_1.successMessage.setDescription('Successfully cleared YouTube channel.'));
    }
    else {
        ...
        if (youtubeRegex.test(args[2])) {
            ...
            player.save();
            message.channel.send(statusMessage_1.successMessage.setDescription('Successfully set YouTube channel.'));
        }
        else {
            message.channel.send(statusMessage_1.errorMessage.setDescription('Invalid YouTube channel URL.'));
        }
    }
});
