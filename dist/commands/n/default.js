...
exports.default = (message, args) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const nation = yield Nation.findOne({ nameLower: query }).exec().catch(err => { throw err; });
    if (!nation)
        throw 'Nation not found.';
    const nationp = yield NationP.findOne({ name: nation.nameLower }).exec().catch(err => { throw err; });
