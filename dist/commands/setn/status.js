...
exports.default = (message, args, nation, nationp) => __awaiter(void 0, void 0, void 0, function* () {
    if (args[3] == 'null') {
        ...
        message.channel.send(statusMessage_1.successMessage.setDescription(`Cleared the nation's status`));
        return;
    }
    ...
    if (!nationp) {
        ...
        newDoc.save(function (err) {
            ...
            message.channel.send(statusMessage_1.successMessage.setDescription(`Set set the nation's status to ${status}`));
        });
    }
    else {
