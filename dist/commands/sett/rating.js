...
exports.default = (message, args, town, townp) => __awaiter(void 0, void 0, void 0, function* () {
    if (args[3] == 'null') {
        ...
        message.channel.send(statusMessage_1.successMessage.setDescription(`Cleared the town's rating.`));
    }
    ...
    if (!townp) {
        ...
        newDoc.save(function (err) {
            ...
            message.channel.send(statusMessage_1.successMessage.setDescription(`Successfully set the town's rating.`));
        });
    }
    else {
